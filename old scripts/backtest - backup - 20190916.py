...
class Strategy():
    ...
    def multi_backtest(self, process_num=5, name=None):
        ...
        for i in range(0, n):
            ...
            p = Process(target=backtest_slice, args = (q, data_slice, i))
            jobs.append(p)
            p.start()
...
if __name__ == "__main__":
    obj = Strategy()
    print(len(obj.date_list))
    obj.multi_backtest(process_num=5)
    obj.printStat()
    # obj.calibrate()
    # print(len(obj.date_list))
    #
